...
import {buildLiveNomadBalloon} from './nomadBalloonExport.js?v=082';
...
document.title='MeshUtilz Balloon v0.8.2';document.querySelector('header span').textContent='Balloon v0.8.2';
$('#exportBtn').insertAdjacentHTML('afterend','<label>Nomad Detail<select id="nomadDetail"><option value="low">Low — easiest editing</option><option value="medium" selected>Medium</option><option value="high">High — closest shape</option></select></label><button id="exportLiveNomBtn" class="export-live-nom">Save Live Nomad Balloon — NOM</button><p id="nomadHint" class="nomad-hint">Exports Tube Balloons as editable Nomad Tube primitives. Nomad Detail simplifies only exported control points; Balloon geometry is unchanged. Outline Balloons are not included.</p>');
